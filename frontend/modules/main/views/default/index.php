    ...
    <div id="slider" class="sl-slider-wrapper">
        ...
        <div class="sl-slider">
            ...
            <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                ...
                <h2><a href="<?=Common::getUrlAdvert($row)?>"><?=\frontend\components\Common::getTitleAdvert($row) ?></a></h2>
                <blockquote>
...
<div class="banner-search">
    <div class="container">
        ...
        <div class="searchbar">
            <div class="row">
                <?=Html::beginForm(\yii\helpers\Url::to('/frontend/web/main/main/find/'),'get') ?>
...
<!-- banner -->
    <!-- banner -->
    <div class="container">
        <div class="properties-listing spacer"> <a href=" "  class="pull-right viewall"></a>
            ...
            <div id="owl-example" class="owl-carousel">
                ...
                foreach($featured as $row):
                    ...
                    <div class="properties">
                        ...
                        <h4><a href="<?=Common::getUrlAdvert($row)?>" ><?=\frontend\components\Common::getTitleAdvert($row) ?></a></h4>
                            ...
                            foreach($recommend as $rec):
                                ...
                                <div class="item <?=($i == 0) ? 'active' : '' ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <h5><a href="<?=Common::getUrlAdvert($rec)?>" ><?=\frontend\components\Common::getTitleAdvert($rec) ?></a></h5>
