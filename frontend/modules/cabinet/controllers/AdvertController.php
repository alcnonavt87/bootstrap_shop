...
class AdvertController extends AuthController
{
    ...
    public function actionStep2()
    {
        ...
        if ($general_image = $model->general_image) {
            $image[] = '<img src="/frontend/web/uploads/adverts/' . $model->idadvert . '/general/small_' . $general_image . '" width=250>';
            ...
            if (is_dir($path)) {
                ...
                foreach ($files as $file) {
                    if (strstr($file, "small_") && !strstr($file, "general")) {
                        $images_add[] = '<img src="/frontend/web/uploads/adverts/' . $model->idadvert . '/' . basename($file) . '" width=250>';
                    }
                }
            }
