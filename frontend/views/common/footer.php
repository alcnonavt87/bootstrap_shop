...
<div class="footer">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                <h4>Follow us</h4>
                <a href="#"><img src=<?php echo Yii::getAlias('@web/images/facebook.png')?>  alt="facebook"></a>
                <a href="#"><img src=<?php echo Yii::getAlias('@web/images/twitter.png')?>  alt="facebook"></a>
                <a href="#"><img src=<?php echo Yii::getAlias('@web/images/linkedin.png')?>  alt="facebook"></a>
                <a href="#"><img src=<?php echo Yii::getAlias('@web/images/instagram.png')?>  alt="facebook"></a>
